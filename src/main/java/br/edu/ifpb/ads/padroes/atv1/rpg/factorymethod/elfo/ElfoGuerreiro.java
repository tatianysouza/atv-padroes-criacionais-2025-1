...
import br.edu.ifpb.ads.padroes.atv1.rpg.abstractfactory.elfo.ElfoGuerreiroAF;
...
public class ElfoGuerreiro implements PersonagemFactory {
    public Personagem criar(String nome) {
        var factory = new ElfoGuerreiroAF();
